    ...
    <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative"> 
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-300 bg-white py-2.5 pl-10 pr-4 text-sm shadow-sm focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20"
              required
            />
          </div>
        </div>
      ...
      <div className="flex flex-wrap items-end gap-4">
        ...
        <div className="flex-1 max-w-[340px] pl-8 pr-8">
          ...
          <div className="flex justify-between rounded-lg border border-slate-300 bg-white p-0.5 gap-1">
            <button
              type="button"
